 ...
 */
public static String version()      {  return "4.1.7"  }
...
//    so they are listed here and shown by default.
    ...
    preferences() {
		section("Query Inputs"){
			...
			input "iconLocation", "text", required: true, defaultValue: "https://raw.githubusercontent.com/HubitatCommunity/Weather-Display-With-DarkSky.net-Forecast-Driver/master/WeatherIcons/", title: "Alternative Icon Location:"
...
def initialize() {
    ...
    iconLocation = (settings?.iconLocation ?: "https://raw.githubusercontent.com/HubitatCommunity/Weather-Display-With-DarkSky.net-Forecast-Driver/master/WeatherIcons/")
